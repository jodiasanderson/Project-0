...
import {projectGetUserById} from '../../remote/project-0-api/project-get-by-id';
...
export const ProfileComponent:FunctionComponent<any> =  (props)=>{
    ...
    //changeUserProfile (await projectGetUserById(userId))
    ...
    useEffect(()=>{
        ...
        let getUser = async ()=>{
            ...
            let userInfo = await projectGetUserById(userId)
